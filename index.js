...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/qrcode_for_gh_4132f1c8bc67_430jpg复制.jpg", id:"qrcode_for_gh_4132f1c8bc67_430jpg复制"},
...
(lib.qrcode_for_gh_4132f1c8bc67_430jpg复制 = function() {
	this.initialize(img.qrcode_for_gh_4132f1c8bc67_430jpg复制);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,430,430);
...
(lib.tman = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(30).call(this.frame_30).wait(12).call(this.frame_42).wait(4).call(this.frame_46).wait(4).call(this.frame_50).wait(4).call(this.frame_54).wait(11).call(this.frame_65).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.aaa_q1).wait(42).to({_off:false},0).wait(24));
...
(lib.lastbg = function(mode,startPosition,loop) {
	...
	this.frame_14 = function() {
		...
		*/
		...
		{ 
			...
			//this.temp=2;	
			this.gotoAndPlay(17);
			window.open('http://a.xiumi.us/board/v5/2tyJp/39906360')
		...
		{  status=0;
			...
			// 开始您的自定义代码
			this.gotoAndPlay(17);
			window.open('http://sharefor.coding.me/')
			// 结束您的自定义代码
		}
	...
	// hover
	this.text = new cjs.Text("正是江南好时节，\n落花时节又逢君!\n更多精彩.敬请期待", "50px 'STXingkai'", "#FFFFFF");
	this.text.name = "text";
	this.text.lineHeight = 55;
	this.text.lineWidth = 474;
	this.text.setTransform(118,737.7);

	this.instance = new lib.qrcode_for_gh_4132f1c8bc67_430jpg复制();
	this.instance.setTransform(116,238);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(68,68,68,0.4)").s().p("EgyKBbbMAAAi21MBkVAAAMAAAC21g");
	this.shape.setTransform(321.1,585.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape},{t:this.instance},{t:this.text}]},15).wait(11));
	...
	this.instance_1 = new lib.dl_top();
	this.instance_1.setTransform(483,219);

	this.instance_2 = new lib.dl_bottom();
	this.instance_2.setTransform(483,759);

	this.instance_3 = new lib.补间77("synched",0);
	this.instance_3.setTransform(555,506);
	this.instance_3._off = true;

	this.instance_4 = new lib.补间76("synched",0);
	this.instance_4.setTransform(721.8,506);

	this.duilian_right.mask = this.instance_1.mask = this.instance_2.mask = this.instance_3.mask = this.instance_4.mask = mask;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.duilian_right}]}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.duilian_right}]},4).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.duilian_right}]},10).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_4}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(16).to({_off:false},0).to({_off:true,x:721.8},9).wait(1));
	...
	this.instance_5.setTransform(333,1173);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5}]}).to({state:[{t:this.instance_6}]},4).to({state:[{t:this.instance_7}]},10).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_6}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({_off:true,y:960},10).wait(2).to({_off:false,y:1194},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1194},9).wait(1));

	// bufu
	this.instance_8 = new lib.result_b_2();
	this.instance_8.setTransform(42,1173);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_8}]}).to({state:[{t:this.instance_9}]},4).to({state:[{t:this.instance_10}]},10).to({state:[{t:this.instance_10}]},2).to({state:[{t:this.instance_9}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(4).to({_off:false},0).to({_off:true,y:957},10).wait(2).to({_off:false,y:1186},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1186},9).wait(1));

	// more
	this.instance_11 = new lib.补间66("synched",0);
	this.instance_11.setTransform(323.5,1188);
	this.instance_11._off = true;

	this.instance_12 = new lib.补间67("synched",0);
	this.instance_12.setTransform(323.5,850);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(4).to({_off:false},0).to({_off:true,y:850},10).wait(2).to({_off:false,y:1188},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(4).to({_off:false},10).wait(2).to({startPosition:0},0).to({_off:true,y:1188},9).wait(1));
	...
	// lasttop
	this.instance_13 = new lib.补间72("synched",0);
	this.instance_13.setTransform(320,-89);

	this.instance_14 = new lib.补间73("synched",0);
	this.instance_14.setTransform(320,89);

	this.instance_15 = new lib.cover_bg_top();

	this.instance_16 = new lib.补间74("synched",0);
	this.instance_16.setTransform(320,89);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).to({state:[{t:this.instance_14}]},4).to({state:[{t:this.instance_15}]},10).to({state:[{t:this.instance_16}]},2).to({state:[{t:this.instance_13}]},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true,y:89},4).wait(12).to({_off:false,y:-89},9).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(16).to({_off:false},0).to({_off:true,y:-89},9).wait(1));

	// 图层 1
	this.instance_17 = new lib.cover_bg_1();

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(26));
